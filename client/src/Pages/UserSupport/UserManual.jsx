  ...
  leaderboard: {
    ...
    subsections: {
      ...
      "points-system": {
        title: "Points System",
        content:
          "<p>Understanding how points are earned across platforms:</p><p class='mt-3'>Our points system is designed to reward consistent practice and contest participation across four major competitive programming platforms. Each platform has specific point allocation rules:</p><h4 class='font-medium text-emerald-600 mt-4 mb-2'>Daily Practice Platforms</h4><div class='bg-gray-50 rounded-lg p-4 my-3'><p class='font-medium'>GeeksforGeeks & LeetCode</p><ul class='space-y-1 list-disc pl-5 mt-2'><li>1 point per day if solved (regardless of number of problems solved)</li><li>Maximum of 1 point per platform per day</li><li>Only practice problems count; contest submissions are not included</li><li>Total maximum of 2 points per day from both platforms combined</li></ul></div><h4 class='font-medium text-emerald-600 mt-4 mb-2'>Contest Platforms</h4><div class='bg-gray-50 rounded-lg p-4 my-3'><p class='font-medium'>Codeforces</p><ul class='space-y-1 list-disc pl-5 mt-2'><li>3 points per question solved in scheduled contests</li><li>Only contests scheduled through our calendar are counted</li><li>Regular practice problems outside contests are not considered</li></ul></div><div class='bg-gray-50 rounded-lg p-4 my-3'><p class='font-medium'>CodeChef</p><ul class='space-y-1 list-disc pl-5 mt-2'><li>Points per solved problem vary based on your star rating:</li></ul><table class='w-full mt-2 text-sm'><thead class='bg-gray-100'><tr><th class='p-2 text-left'>Rating</th><th class='p-2 text-left'>Points per Problem</th></tr></thead><tbody><tr class='border-b border-gray-200'><td class='p-2'>1 Star</td><td class='p-2'>2 points</td></tr><tr class='border-b border-gray-200'><td class='p-2'>2 Stars</td><td class='p-2'>3 points</td></tr><tr class='border-b border-gray-200'><td class='p-2'>3 Stars</td><td class='p-2'>4 points</td></tr><tr><td class='p-2'>4 Stars</td><td class='p-2'>5 points</td></tr></tbody></table><ul class='space-y-1 list-disc pl-5 mt-2'><li>Only contests scheduled through our calendar are counted</li><li>Regular practice problems outside contests are not considered</li></ul></div><p class='mt-3 font-medium'>Important Notes:</p><ul class='space-y-2 list-disc pl-5 mt-2'><li>Points are calculated automatically through our platform integration with each coding site</li><li>Verification of your platform profiles is required for points to be tracked</li><li>The system updates daily to reflect your latest activities across all platforms</li></ul>",
      },
      "passing-criteria": {
        title: "Minimum Performance Requirements",
        content:
          "<p>Understanding our membership activity requirements:</p><p class='mt-3'>To maintain active membership and advance within our chapter, members must meet or exceed the minimum performance threshold set by administrators.</p><p class='mt-3'>The minimum passing mark is a fixed value that may be adjusted based on overall community activity levels and program goals. This threshold is clearly displayed on the leaderboard, and members falling below this mark are highlighted in red.</p><p class='mt-3'>Important policies regarding minimum requirements:</p><ul class='space-y-2 list-disc pl-5 mt-3'><li>Members must achieve at least the exact minimum score (not below by even 1 point)</li><li>Those who fail to meet requirements are removed from active membership</li><li>Regular members who consistently exceed requirements are eligible for promotion to core member status</li><li>New applicants meeting these criteria bypass the waiting list for faster admission</li></ul><p class='mt-3'>This system ensures that our community remains active, engaged, and committed to continuous improvement. The current minimum passing mark and your progress toward it can be viewed on your personal dashboard.</p>",
      },
    },
  },
  resources: {
...
export default function UserManual() {
  ...
  useEffect(() => {
    if (content[activeSection]) {
      const defaultSubsection = Object.keys(
        content[activeSection].subsections
      )[0];
